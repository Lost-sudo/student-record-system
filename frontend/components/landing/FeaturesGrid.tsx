...
const features = [
  {
    ...
    iconBg: "bg-indigo-900/30 group-hover:bg-indigo-800/40",
    hoverBorder: "hover:border-indigo-700/50",
    hoverShadow: "hover:shadow-xl hover:shadow-indigo-900/30",
  ...
  },
  {
    ...
    iconBg: "bg-purple-900/30 group-hover:bg-purple-800/40",
    hoverBorder: "hover:border-purple-700/50",
    hoverShadow: "hover:shadow-xl hover:shadow-purple-900/30",
  ...
  },
  {
    ...
    iconBg: "bg-cyan-900/30 group-hover:bg-cyan-800/40",
    hoverBorder: "hover:border-cyan-700/50",
    hoverShadow: "hover:shadow-xl hover:shadow-cyan-900/30",
  ...
  },
  {
    ...
    iconBg: "bg-green-900/30 group-hover:bg-green-800/40",
    hoverBorder: "hover:border-green-700/50",
    hoverShadow: "hover:shadow-xl hover:shadow-green-900/30",
  ...
  },
  {
    ...
    iconBg: "bg-amber-900/30 group-hover:bg-amber-800/40",
    hoverBorder: "hover:border-amber-700/50",
    hoverShadow: "hover:shadow-xl hover:shadow-amber-900/30",
  ...
  },
  {
    ...
    iconBg: "bg-red-900/30 group-hover:bg-red-800/40",
